        ...
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-8 flex gap-5">
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition-all hover:bg-primary hover:text-white hover:scale-110 shadow-sm"
                aria-label="Twitter"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="#"
                  className="text-base text-slate-300 hover:text-primary transition-colors"
                >
                  About Us
                </a>
              </li>
